...
class UpdateVoyageRequest extends FormRequest
{
    ...
    {
        return [
            'adresse_depot_id' => ['sometimes', 'required', 'uuid', 'exists:adresse_depots,id'],
            'adresse_recuperation_id' => ['sometimes', 'required', 'uuid', 'exists:adresse_recuperations,id'],
            'pays_depart' => ['sometimes', 'required', 'string', 'max:100'],
            'ville_depart' => ['sometimes', 'required', 'string', 'max:100'],
            'pays_destination' => ['sometimes', 'required', 'string', 'max:100'],
            'ville_destination' => ['sometimes', 'required', 'string', 'max:100'],
            'date_depart' => ['sometimes', 'required', 'date'],
            'date_arrivee' => ['sometimes', 'required', 'date', 'after:date_depart'],
            'capacite_totale' => ['sometimes', 'required', 'numeric', 'gt:0'],
